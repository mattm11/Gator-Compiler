    ...
    private static Stream<Arguments> testLiteralExpression() {
        return Stream.of(
                Arguments.of("Boolean",
                        // TRUE
                        init(new Ast.Expr.Literal(true), ast -> ast.setType(Environment.Type.BOOLEAN)), "true"
                ),
                Arguments.of("Integer",
                        init(new Ast.Expr.Literal(BigInteger.ONE), ast -> ast.setType(Environment.Type.INTEGER)), "1"
                ),
                Arguments.of("Decimal",
                        init(new Ast.Expr.Literal(BigDecimal.valueOf(1.11)), ast -> ast.setType(Environment.Type.DECIMAL)), "1.11"
                )
        );
    }
